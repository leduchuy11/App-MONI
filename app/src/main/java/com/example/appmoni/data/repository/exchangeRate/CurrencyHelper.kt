...
object CurrencyHelper {
    fun getSupportedCurrencies(): List<CurrencyItem> {
        return listOf(
            ...
            CurrencyItem("MOP$", "MOP", "Macanese Pataca", R.drawable.ic_flag_mo),
            ...
            CurrencyItem("Mex$", "MXN", "Mexican Peso", R.drawable.ic_flag_mx),
            CurrencyItem("R$", "BRL", "Brazilian Real", R.drawable.ic_flag_br),
            CurrencyItem("AR$", "ARS", "Argentine Peso", R.drawable.ic_flag_ar),
            CurrencyItem("CLP$", "CLP", "Chilean Peso", R.drawable.ic_flag_cl),
            CurrencyItem("COP$", "COP", "Colombian Peso", R.drawable.ic_flag_co),
